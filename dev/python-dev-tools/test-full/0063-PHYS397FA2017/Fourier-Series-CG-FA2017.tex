...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% 0063 PHYS397FA2017 - Companion Guide
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%function
\draw[domain=0.2:5.8]plot [samples=300](\x,{2.7+.7*(sin(3.14159*\x r)-.5*sin(2*3.14159*\x r)+.333*sin(3*3.14159*\x r)-.25*sin(4*3.14159*\x r)+
.2*sin(5*3.14159*\x r)-.167*sin(6*3.14159*\x r)+.143*sin(7*3.14159*\x r)-.125*sin(8*3.14159*\x r)+.111*sin(9*3.14159*\x r))});
\end{tikzpicture}
\caption{A sketch of the synthesized ramp function.}
\label{fig:fscg5}
\end{marginfigure}
...
%function
\draw[domain=0.2:5.8]plot [samples=300](\x,{2.5+.7*(sin(3.14159*\x r)-.111*sin(3*3.14159*\x r)
+.04*sin(5*3.14159*\x r)-.02*sin(7*3.14159*\x r)+.012*sin(9*3.14159*\x r))});
\end{tikzpicture}
\caption{A sketch of the synthesized triangle wave.}
\label{fig:fscg6}
\end{marginfigure}
...
+.2*sin(5*3.14159*\x r)+.167*sin(6*3.14159*\x r)+.143*sin(7*3.14159*\x r)+.125*sin(8*3.14159*\x r)+.111*sin(9*3.14159*\x r))});
\end{tikzpicture}
\caption{A sketch of the synthesized sawtooth wave.}
\label{fig:fscg7}
\end{marginfigure}
...
\item {\bf Explain how to find the amplitude coefficient, $A_n$, and the phase coefficient, $\phi_n$, from the Fourier sine and cosine coefficients, $a_n$ and $b_n$.}\newline
...
%function
\draw[domain=0.2:5.8]plot [samples=300](\x,{2.5-(3)*(cos(4*\x r)/3+cos(8*\x r)/15
+cos(12*\x r)/35+cos(16*\x r)/63)});
\end{tikzpicture}
\caption{A sketch of the synthesized full rectified wave.}
\label{fig:fscg8}
\end{marginfigure}
...
%function
\draw[domain=0.2:5.8]plot [samples=300](\x,{2.5+sin(4*\x r)-1.274*(cos(8*\x r)/3+cos(16*\x r)/15
+cos(24*\x r)/35+cos(32*\x r)/63)});
\end{tikzpicture}
\caption{A sketch of the synthesized half rectified wave.}
\label{fig:fscg9}
\end{marginfigure}
...
%function
\draw[domain=3.2:8.8,shift={(-3,2.1)}]plot [samples=300](\x,{.25+
(2/3.14)*sin(.5*1*3.14*.25 r)*cos(.5*3.14*1*\x r)+
(1/3.14)*sin(.5*2*3.14*.25 r)*cos(.5*3.14*2*\x r)+
(2/3/3.14)*sin(.5*3*3.14*.25 r)*cos(.5*3.14*3*\x r)+
(1/2/3.14)*sin(.5*4*3.14*.25 r)*cos(.5*3.14*4*\x r)+
(2/5/3.14)*sin(.5*5*3.14*.25 r)*cos(.5*3.14*5*\x r)+
(1/3/3.14)*sin(.5*6*3.14*.25 r)*cos(.5*3.14*6*\x r)+
(2/7/3.14)*sin(.5*7*3.14*.25 r)*cos(.5*3.14*7*\x r)+
(1/4/3.14)*sin(.5*8*3.14*.25 r)*cos(.5*3.14*8*\x r)+
(2/9/3.14)*sin(.5*9*3.14*.25 r)*cos(.5*3.14*9*\x r)});
\end{tikzpicture}
\caption{A sketch of the synthesized 25\% duty cycle square wave.}
\label{fig:fscg16}
\end{marginfigure}
...
\noindent So we start with the following trigonometric identity,

\begin{equation}
Asin(x\pm y)=Asin(x)cos(y)\pm Acos(x)sin(y)
\label{equ:fscg2}
\end{equation}

\noindent Applying this identity to our original expression yields


\begin{equation}
A_nsin\left(\dfrac{2n\pi}{T}t\right)cos(\phi_n)+A_ncos\left(\dfrac{2n\pi}{T}t\right)sin(\phi_n)
\label{equ:fscg3}
\end{equation}

\noindent Rearranging gives us

\begin{equation}
A_nsin(\phi_n)cos\left(\dfrac{2n\pi}{T}t\right)+A_ncos(\phi_n)sin\left(\dfrac{2n\pi}{T}t\right)
\label{equ:fscg4}
\end{equation}
...
%function
\draw[domain=3.2:8.8,shift={(-3,2.1)}]plot [samples=300](\x,{.33+
(2/3.14)*sin(.5*1*3.14*.33 r)*cos(.5*3.14*1*\x r)+
(1/3.14)*sin(.5*2*3.14*.33 r)*cos(.5*3.14*2*\x r)+
(2/3/3.14)*sin(.5*3*3.14*.33 r)*cos(.5*3.14*3*\x r)+
(1/2/3.14)*sin(.5*4*3.14*.33 r)*cos(.5*3.14*4*\x r)+
(2/5/3.14)*sin(.5*5*3.14*.33 r)*cos(.5*3.14*5*\x r)+
(1/3/3.14)*sin(.5*6*3.14*.33 r)*cos(.5*3.14*6*\x r)+
(2/7/3.14)*sin(.5*7*3.14*.33 r)*cos(.5*3.14*7*\x r)+
(1/4/3.14)*sin(.5*8*3.14*.33 r)*cos(.5*3.14*8*\x r)+
(2/9/3.14)*sin(.5*9*3.14*.33 r)*cos(.5*3.14*9*\x r)});
\end{tikzpicture}
\caption{A sketch of the synthesized 33\% duty cycle square wave.}
\label{fig:fscg17}
\end{marginfigure}
...
%function
\draw[domain=3.2:8.8,shift={(-3,2.1)}]plot [samples=300](\x,{.083+
(2/3.14)*sin(.5*1*3.14*.083 r)*cos(.5*3.14*1*\x r)+
(1/3.14)*sin(.5*2*3.14*.083 r)*cos(.5*3.14*2*\x r)+
(2/3/3.14)*sin(.5*3*3.14*.083 r)*cos(.5*3.14*3*\x r)+
(1/2/3.14)*sin(.5*4*3.14*.083 r)*cos(.5*3.14*4*\x r)+
(2/5/3.14)*sin(.5*5*3.14*.083 r)*cos(.5*3.14*5*\x r)+
(1/3/3.14)*sin(.5*6*3.14*.083 r)*cos(.5*3.14*6*\x r)+
(2/7/3.14)*sin(.5*7*3.14*.083 r)*cos(.5*3.14*7*\x r)+
(1/4/3.14)*sin(.5*8*3.14*.083 r)*cos(.5*3.14*8*\x r)+
(2/9/3.14)*sin(.5*9*3.14*.083 r)*cos(.5*3.14*9*\x r)});
\end{tikzpicture}
\caption{A sketch of the synthesized 8.3\% duty cycle square wave.}
\label{fig:fscg18}
\end{marginfigure}
...
\begin{figure}[ht]
\includegraphics{/usr/local/master/labs/physics397-FA2017/0063-PHYS397FA2017/FS-datareq4.jpg}
...
\begin{figure}[ht]
\includegraphics{/usr/local/master/labs/physics397-FA2017/0063-PHYS397FA2017/FS-datareq5.jpg}
...
%labels
\draw[](4.75,4.3)--(9.6,4.3);
\draw[](4.75,4.2)--(4.75,4.4);
\draw[](9.6,4.2)--(9.6,4.4);
\draw[](2,4.3)--(2.5,4.3);
\draw[](2,4.2)--(2,4.4);
\draw[](2.5,4.2)--(2.5,4.4);
\node[]at(2.25,4.6){$T_1$};
\node[]at(7,4.6){$T_2$};
%function
\draw[domain=0:10,shift={(0,0)}]plot [samples=400](\x,{sin(600*\x)+sin(750*\x)+2});
\draw[very thin,draw=lightgray,domain=0:10,shift={(0,0)}]plot [samples=100](\x,{2*cos(75*\x)+2});
\end{tikzpicture}
...
\begin{marginfigure}
\includegraphics[scale=.85]{/usr/local/master/labs/physics397-FA2017/0063-PHYS397FA2017/FS-ramp-sketch.jpg}
...
\begin{marginfigure}
\includegraphics[scale=.85]{/usr/local/master/labs/physics397-FA2017/0063-PHYS397FA2017/FS-sawtooth-sketch.jpg}
...
\begin{marginfigure}
\includegraphics[scale=.85]{/usr/local/master/labs/physics397-FA2017/0063-PHYS397FA2017/FS-triangle-sketch.jpg}
...
%function
\draw[domain=0.2:5.8]plot [samples=300](\x,{2.5+1.5*(sin(3.14159*\x r)+.333*sin(3*3.14159*\x r)
+.2*sin(5*3.14159*\x r)+.143*sin(7*3.14159*\x r)+.111*sin(9*3.14159*\x r))});
\end{tikzpicture}
...
\begin{marginfigure}
\includegraphics[scale=.85]{/usr/local/master/labs/physics397-FA2017/0063-PHYS397FA2017/FS-PSK-sketch.jpg}
\caption{A photo of the synthesized PSK wave.}
\label{fig:fscg13}
\end{marginfigure}

\begin{marginfigure}
\includegraphics[scale=.85]{/usr/local/master/labs/physics397-FA2017/0063-PHYS397FA2017/FS-FSK-sketch.jpg}
...
\begin{marginfigure}
\includegraphics[scale=.85]{/usr/local/master/labs/physics397-FA2017/0063-PHYS397FA2017/FS-ASK-sketch.jpg}
