%Created on: Apr 28, 2014       Edited by: Peter Gimby
...
%Edited on: Aug 21, 2017        Edited by: Ania Harlick
%Edited on: Sept 5, 2017		   Edited by: Peter Gimby - Moved some figures that where running off of the page
...
\includegraphics{Voltage-Dividers-and-Voltage-Sources-Setup.jpg}
...
\begin{marginfigure}
\includegraphics{Voltage-Dividers-and-Voltage-Sources-Resistors.jpg}
...
\begin{figure}
\includegraphics{VariableVD.png}
\caption{Response of a basic voltage divider}
\end{figure}
...
\begin{figure}
\includegraphics{TheveninA.png}
\caption{Thevein equivalents for circuit A}
\end{figure}

\begin{figure}
\includegraphics{TheveninB.png}
\caption{Thevein equivalents for circuit B}
\end{figure}

\begin{figure}
\includegraphics{TheveninC.png}
