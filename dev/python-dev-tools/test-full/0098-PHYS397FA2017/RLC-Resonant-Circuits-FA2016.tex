\input{/usr/local/master/labs/physics397-FA2016/standard-preamble.tex}
\begin{document}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
\begin{figure}
\begin{tikzpicture}[circuit ee IEC]
\node at (0,5){\includegraphics[width=110pt]{/usr/local/master/labs/physics397-FA2016/RLC-Resonant-Circuits/RLC-Resonant-Circuits-func-gen.png}}; %function generator
...
\node at (0,2){\includegraphics[width=140pt]{/usr/local/master/labs/physics397-FA2016/RLC-Resonant-Circuits/RLC-Resonant-Circuits-osc-controls.png}}; %oscillocope
