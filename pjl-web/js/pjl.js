...
$(document).on("click touch", ".resource-dropdown-content, .mobile-resource-dropdown-content", function(e) {
	let links = {"pjl-regress": "/",
				 ...
				 "pjl-lab-toc": "/data/safety/lab-safety-manual/Lab-Safety-Manual-ToC.pdf",
				 "pjl-lab-intro": "/data/safety/lab-safety-manual/laboratory_safety_manual_introduction.pdf",
				 "pjl-lab-hacf-staff": "/data/safety/lab-safety-manual/HACF-PJL.pdf",
				 "pjl-lab-hacf-adv": "/data/safety/lab-safety-manual/HACF-TA-Advanced.pdf",
				 "pjl-lab-hacf-stand": "/data/safety/lab-safety-manual/HACF-TA-Standard.pdf",
				 "pjl-orientation": "/data/safety/lab-safety-manual/Orientation.pdf",
				 "pjl-lab-rad": "/data/safety/lab-safety-manual/closed/Radiation-Safety.pdf",
				 "pjl-lab-laser": "/data/safety/lab-safety-manual/uofclasersafetymanual.pdf",
				 "pjl-lab-emerg": "/data/safety/lab-safety-manual/Emergency-Procedures-Placard.pdf",
				 "pjl-lab-oars": "/data/safety/lab-safety-manual/oarsworksheet.pdf",
				 "pjl-lab-spills": "/data/safety/lab-safety-manual/spillresponseprocedures.pdf",
				 "pjl-lab-eyes": "/data/safety/lab-safety-manual/emergencyshowerandeyewashstandard.pdf",
				 "pjl-lab-rules-placard": "/data/safety/lab-safety-manual/lab-rules-placard.pdf",
				 "pjl-lab-rules": "/data/safety/lab-safety-manual/laboratorysafetyrules.pdf",
				 "pjl-lab-hazard-move": "/data/safety/lab-safety-manual/movementofhazardousmaterialswithinbuildings.pdf",
				 "pjl-lab-after-hrs": "/data/safety/lab-safety-manual/labafter-hoursoperations-signed.pdf",
				 "pjl-lab-unattend": "/data/safety/lab-safety-manual/labunattendedoperations-signed.pdf",
				 "pjl-lab-unattend-guide": "/data/safety/lab-safety-manual/unattendedoperationsguidelines.pdf",
				 "pjl-lab-alone": "/data/safety/lab-safety-manual/workingaloneguidelines.pdf",
				 "pjl-lab-comp-gas-hand": "/data/safety/lab-safety-manual/compressedgascylinderusehandlingandstoragestandard.pdf",
				 "pjl-lab-comp-regulator": "/data/safety/lab-safety-manual/compressedgascylinderregulatorinstallationsop.pdf",
				 "pjl-lab-chem-storage": "/data/safety/lab-safety-manual/chemicalstorage.pdf",
				 "pjl-lab-chem-storage-sup": "/data/safety/lab-safety-manual/chemical_storage_guidelines_supplemental_information.pdf",
				 "pjl-lab-fire": "/data/safety/lab-safety-manual/labaccessegressfiresafetyrequirements.pdf",
				 "pjl-lab-fumehood": "/data/safety/lab-safety-manual/laboratoryfumehooduserstandard.pdf",
				 "pjl-orientation-present": "/data/safety/training/Orientation-Presentations/index.html",
				 "pjl-sop-sander": "/data/safety/lab-safety-manual/Belt-Sander.pdf",
				 "pjl-sop-dremel": "/data/safety/lab-safety-manual/Dremel.pdf",
				 "pjl-sop-mill": "/data/safety/lab-safety-manual/Milling-Machine.pdf",
				 "pjl-lab-waste": "/data/safety/lab-safety-manual/hazardouswastedisposal.pdf",
